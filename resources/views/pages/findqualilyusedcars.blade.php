        ...
        <form action="{{ route('booking_search_cars') }}" method='post' id="search_cars">
            ...
            <div class="form-group col-md-3" style="position: absolute; top: 35%; left: 55%;">
                <div class="form-group row"
                    style="justify-content: center; border-radius: 10px; background-color: #fff; box-shadow: 1px 1px 3px 3px rgba(199, 196, 196, 0.349); padding: 15px">
                    ...
                    <div class="form-group row col-md-12">
                        ...
                        <select style="height: 35px;"
                            class="form-control form-control-sm form-border mt-0 mt-lg-auto title-search" name="brand"
                            id="brand">
                    ...
                    <div class="form-group row col-md-12">
                        ...
                        <select style="height: 35px;"
                            class="form-control form-control-sm form-border mt-0 mt-lg-auto title-search" name="carmodel"
                            id="carmodel">
                            <option value="">@lang('frontend.findqualily.pleaseselect')</option>
                        </select>
                    </div>
                    <div class="form-group row col-md-12">
                        ...
                        <input type="text" style="height: 35px;" class="form-control form-control-sm form-border"
                            name="name" id="name">
                    </div>
                    <div class="form-group row col-md-12">
                        <label>@lang('frontend.findqualily.tel')</label>
                        <input type="text" style="height: 35px;" class="form-control form-control-sm form-border" name="tel"
                            id="tel">
                    </div>
                    <hr class="my-3" style="width: 97%; margin: 0px auto; border-color: #dadad3;">
                    <div class="form-group row col-md-12">
                        <label></label>
                        <button id="btnSerarch" type="submit" class="btn bg-schic btn-sm form-control form-border"
                            style="font-size: 1em; border-radius: 30px; color: #fff">@lang('frontend.findqualily.search')</button>
                    </div>
