...
@section('content')
    <div class="bg-image" style="background-image: url('{{ asset('media/photos/services/sub_02@2x.jpg') }}');">
                    ...
                    <div class="row">
                        ...
                        <div class="row gutters-tiny items-push js-gallery push img-fluid-100 js-gallery-enabled">
                            <div class="col-12 animated fadeIn">
                                <div class="">
                                    <img class="img-fluid" src="{{ asset('media/photos/services/sub_02@2x.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
