        ...
        <div class="bg-primary-dark-op">
            <div class="content content-full overflow-hidden">
                <div class="mt-7 mb-5 text-center">
                    <h1 style="font-family:SukhumvitSet;" class="h2 text-white mb-2 js-appear-enabled animated fadeInDown" data-toggle="appear" data-class="animated fadeInDown">@lang('frontend.Leadership_Training_Qualification.title')</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="row">
                            <p class="row">
                                @lang('frontend.Leadership_Training_Qualification.content')
                            </p>
                            <p class="row">
                                @lang('frontend.Leadership_Training_Qualification.content1')
                            </p>
                        </div>
                        <div class="row">
