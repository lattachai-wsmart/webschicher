        ...
        <div class="bg-primary-dark-op">
            <div class="content content-full overflow-hidden">
                <div class="mt-7 mb-5 text-center">
                    <h1 class="h2 text-white mb-2 js-appear-enabled animated fadeInDown" data-toggle="appear" data-class="animated fadeInDown">@lang('frontend.Sales_Training_Qualification.title')</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="row">
                            <h5 class="row h5">@lang('frontend.Sales_Training_Qualification.title1')</h5>
                            <p class="row">
                        ...
                        <div class="row">
                            ...
                            <h5 class="row h5">@lang('frontend.Sales_Training_Qualification.title2')</h5>
                            <p class="mb-1">
